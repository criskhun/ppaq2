...
<div class="offcanvas offcanvas-start" id="CGdem">
  <div class="offcanvas-header">
    <h1 class="offcanvas-title">Document QR Code</h1>
...
<div class="container-fluid mt-3">
  <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#demo"><i class="fa-solid fa-bars"></i>
    Open Menu
  </button>
</div>
